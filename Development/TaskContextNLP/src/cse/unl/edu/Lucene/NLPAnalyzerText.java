...
public class NLPAnalyzerText extends Analyzer {
	...
	protected TokenStreamComponents createComponents(String field, Reader reader) {
		...
		TokenStream result = new NLPFilterText(Version.LUCENE_47, stream,".*/(VB|VBD|VBG|VBN|VBP|VBZ|RB|RBR|RBS|CD|DT|JJ|JJR|JJS|NN|NNS|NNP|NNPS)$");
