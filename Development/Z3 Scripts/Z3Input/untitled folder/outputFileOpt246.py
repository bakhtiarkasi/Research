...
s.add(Implies(DC[0], D4[4] != D5[2]))
s.add(Implies(DC[1], D3[7] != D4[7]))
s.add(Implies(DC[2], D4[0] != D5[3]))
s.add(Implies(DC[3], D4[5] != D6[4]))
s.add(Implies(DC[4], D1[4] != D2[8]))
s.add(Implies(DC[5], D1[4] != D6[7]))
s.add(Implies(DC[6], D2[2] != D4[2]))
s.add(Implies(DC[7], D5[0] != D6[4]))

##Adding InDirect Conflicts
s.add(Implies(IC[0], D1[5] > D3[5]))
s.add(Implies(IC[1], D3[3] > D6[1]))
s.add(Implies(IC[2], D1[5] > D5[0]))
s.add(Implies(IC[3], D1[4] > D5[0]))
s.add(Implies(IC[4], D1[6] > D2[1]))
s.add(Implies(IC[5], D5[0] > D6[3]))
s.add(Implies(IC[6], D5[2] > D6[4]))
s.add(Implies(IC[7], D3[1] > D6[7]))
s.add(Implies(IC[8], D2[6] > D5[0]))
s.add(Implies(IC[9], D2[8] > D5[0]))
s.add(Implies(IC[10], D4[5] > D6[4]))
s.add(Implies(IC[11], D1[6] > D6[5]))
s.add(Implies(IC[12], D1[3] > D6[1]))
s.add(Implies(IC[13], D1[4] > D5[7]))
s.add(Implies(IC[14], D3[0] > D4[1]))
s.add(Implies(IC[15], D2[2] > D6[1]))
s.add(Implies(IC[16], D3[1] > D4[7]))
s.add(Implies(IC[17], D2[8] > D3[7]))
s.add(Implies(IC[18], D1[1] > D2[6]))
s.add(Implies(IC[19], D3[4] > D6[4]))
s.add(Implies(IC[20], D2[2] > D6[5]))
s.add(Implies(IC[21], D2[6] > D6[3]))
s.add(Implies(IC[22], D4[5] > D6[3]))
s.add(Implies(IC[23], D1[4] > D3[2]))
s.add(Implies(IC[24], D5[3] > D6[1]))
s.add(Implies(IC[25], D2[1] > D5[4]))
s.add(Implies(IC[26], D2[8] > D3[7]))
s.add(Implies(IC[27], D3[7] > D6[8]))
s.add(Implies(IC[28], D1[6] > D3[3]))
s.add(Implies(IC[29], D1[7] > D4[4]))
s.add(Implies(IC[30], D3[4] > D5[5]))
s.add(Implies(IC[31], D3[3] > D5[3]))
s.add(Implies(IC[32], D2[3] > D4[3]))
s.add(Implies(IC[33], D3[6] > D6[6]))
s.add(Implies(IC[34], D1[3] > D3[7]))
