...
s.add(Implies(IC[0], D1[3] > D3[0]))
s.add(Implies(IC[1], D1[2] > D3[4]))
s.add(Implies(IC[2], D2[7] > D3[4]))
s.add(Implies(IC[3], D1[8] > D3[1]))
s.add(Implies(IC[4], D1[6] > D2[5]))
s.add(Implies(IC[5], D1[8] > D2[3]))
s.add(Implies(IC[6], D1[4] > D3[0]))
s.add(Implies(IC[7], D1[4] > D2[0]))
s.add(Implies(IC[8], D2[7] > D3[8]))
s.add(Implies(IC[9], D1[0] > D3[0]))
s.add(Implies(IC[10], D1[0] > D3[3]))
s.add(Implies(IC[11], D2[3] > D3[5]))
s.add(Implies(IC[12], D2[1] > D3[2]))
s.add(Implies(IC[13], D1[2] > D2[0]))
s.add(Implies(IC[14], D1[8] > D2[2]))
s.add(Implies(IC[15], D1[8] > D3[8]))
s.add(Implies(IC[16], D2[2] > D3[6]))
s.add(Implies(IC[17], D1[4] > D2[0]))
s.add(Implies(IC[18], D1[7] > D3[7]))
s.add(Implies(IC[19], D1[8] > D2[1]))
s.add(Implies(IC[20], D1[0] > D3[0]))
s.add(Implies(IC[21], D1[8] > D3[6]))
s.add(Implies(IC[22], D1[5] > D3[6]))
s.add(Implies(IC[23], D1[5] > D2[4]))
s.add(Implies(IC[24], D2[0] > D3[8]))
