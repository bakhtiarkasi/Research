...
s.add(Implies(DC[0], D3[3] != D6[5]))
s.add(Implies(DC[1], D2[1] != D4[0]))
s.add(Implies(DC[2], D1[2] != D2[1]))
s.add(Implies(DC[3], D3[5] != D4[0]))
s.add(Implies(DC[4], D4[1] != D6[5]))
s.add(Implies(DC[5], D2[0] != D4[1]))
s.add(Implies(DC[6], D1[4] != D3[1]))
s.add(Implies(DC[7], D3[2] != D5[2]))
s.add(Implies(DC[8], D1[1] != D5[5]))
s.add(Implies(DC[9], D1[3] != D4[3]))

##Adding InDirect Conflicts
s.add(Implies(IC[0], D1[3] > D2[1]))
s.add(Implies(IC[1], D2[5] > D4[2]))
s.add(Implies(IC[2], D1[0] > D6[3]))
s.add(Implies(IC[3], D3[5] > D6[4]))
s.add(Implies(IC[4], D4[0] > D5[5]))
