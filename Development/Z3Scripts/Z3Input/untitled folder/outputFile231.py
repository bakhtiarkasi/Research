...
valueConst = [1 <= D1[0], D1[0] <= 4,1 <= D1[1], D1[1] <= 4,1 <= D1[2], D1[2] <= 4,1 <= D1[3], D1[3] <= 4,\
		1 <= D2[0], D2[0] <= 4,1 <= D2[1], D2[1] <= 4,1 <= D2[2], D2[2] <= 4,1 <= D2[3], D2[3] <= 4,\
		1 <= D3[0], D3[0] <= 4,1 <= D3[1], D3[1] <= 4,1 <= D3[2], D3[2] <= 4,1 <= D3[3], D3[3] <= 4]
...
s.add(Implies(IC[0], D1[0] > D2[1]))
s.add(Implies(IC[1], D1[2] > D3[3]))
