...
s.add(Implies(DC[0], D5[4] != D7[6]))
s.add(Implies(DC[1], D2[2] != D3[4]))
s.add(Implies(DC[2], D4[1] != D5[0]))
s.add(Implies(DC[3], D5[0] != D7[6]))
s.add(Implies(DC[4], D1[0] != D7[3]))
s.add(Implies(DC[5], D6[1] != D8[2]))
s.add(Implies(DC[6], D7[4] != D8[0]))
s.add(Implies(DC[7], D5[2] != D6[2]))
s.add(Implies(DC[8], D2[4] != D8[4]))
s.add(Implies(DC[9], D2[3] != D4[3]))
s.add(Implies(DC[10], D2[0] != D8[4]))
s.add(Implies(DC[11], D3[1] != D4[2]))
s.add(Implies(DC[12], D3[4] != D4[0]))
s.add(Implies(DC[13], D3[2] != D4[2]))
s.add(Implies(DC[14], D1[3] != D7[5]))
s.add(Implies(DC[15], D2[0] != D4[4]))
s.add(Implies(DC[16], D4[4] != D7[5]))
s.add(Implies(DC[17], D4[3] != D6[4]))
s.add(Implies(DC[18], D1[3] != D3[3]))
s.add(Implies(DC[19], D6[2] != D7[1]))
s.add(Implies(DC[20], D2[4] != D8[0]))

##Adding InDirect Conflicts
s.add(Implies(IC[0], D4[1] > D5[1]))
s.add(Implies(IC[1], D7[2] > D8[3]))
s.add(Implies(IC[2], D1[2] > D8[4]))
s.add(Implies(IC[3], D6[3] > D8[5]))
s.add(Implies(IC[4], D5[2] > D7[6]))
s.add(Implies(IC[5], D1[2] > D2[1]))
s.add(Implies(IC[6], D2[4] > D3[5]))
s.add(Implies(IC[7], D6[2] > D8[0]))
s.add(Implies(IC[8], D4[5] > D6[4]))
s.add(Implies(IC[9], D5[2] > D6[0]))
s.add(Implies(IC[10], D1[4] > D8[3]))
s.add(Implies(IC[11], D1[5] > D8[0]))
s.add(Implies(IC[12], D1[2] > D7[2]))
s.add(Implies(IC[13], D1[1] > D8[1]))
s.add(Implies(IC[14], D1[3] > D7[3]))
s.add(Implies(IC[15], D5[3] > D6[5]))
s.add(Implies(IC[16], D1[2] > D3[5]))
s.add(Implies(IC[17], D3[2] > D4[2]))
s.add(Implies(IC[18], D7[5] > D8[2]))
s.add(Implies(IC[19], D2[6] > D4[2]))
s.add(Implies(IC[20], D3[3] > D5[0]))
s.add(Implies(IC[21], D5[3] > D8[3]))
